...
#robot -d Results TestSuite/ExploratoryTest_Yahoo.robot
#robot -d Results --variable browser:firefox TestSuite/ExploratoryTest_Yahoo.robot
#robot -d Results --include TYPO TestSuite/ExploratoryTest_Yahoo.robot
#robot -d Results --include TYHL TestSuite/ExploratoryTest_Yahoo.robot
#robot -d Results --include TYNL TestSuite/ExploratoryTest_Yahoo.robot
#robot -d Results --include TYSL TestSuite/ExploratoryTest_Yahoo.robot
