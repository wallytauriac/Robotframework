...
#robot -d Result3 TestSuite/ExploratoryTest3_Yahoo.robot
#robot -d Result3 --variable browser:firefox TestSuite/ExploratoryTest3_Yahoo.robot
#robot -d R_TYPO --include TYPO TestSuite/ExploratoryTest3_Yahoo.robot
#robot -d R_TYHL --include TYHL TestSuite/ExploratoryTest3_Yahoo.robot
#robot -d R_TYNL --include TYNL TestSuite/ExploratoryTest3_Yahoo.robot
#robot -d R_TYSL --include TYSL TestSuite/ExploratoryTest3_Yahoo.robot
