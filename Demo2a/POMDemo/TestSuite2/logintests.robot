...
Valid Login Test                 ${VALID USER}    ${VALID PASSWORD}
...
Login With User Credentials
    ...
    Submit Credentials
    ${passed}=  Run Keyword And Return Status  Set Focus To Element  ${btn_logout}
    Run Keyword If  ${passed}  Click Logout
    ...     ELSE  Login Should Have Failed
